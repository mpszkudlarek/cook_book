                ...
                <div className="relative ml-2 group transition-transform duration-300 ease-in-out hover:scale-110">
                    ...
                    <div
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                            Tutaj znajdziesz odpowiedzi na najczęściej zadawane pytania dotyczące korzystania z naszej
                            aplikacji.
                        </p>
                    </div>
                </div>
            ...
            <div className="grid gap-6">
                {faqs.map((faq, index) => (
                    <Card key={index} className="bg-white dark:bg-gray-800 hover:shadow-md transition-shadow">
                        <CardHeader>
                            <CardTitle
                                className="text-lg font-semibold text-gray-900 dark:text-gray-100">{faq.question}</CardTitle>
                        </CardHeader>
                        <CardContent>
            ...
            <Card className="bg-white dark:bg-gray-100">
                ...
                <CardContent>
                    <p className="text-black dark:text-gray-900 mb-4">
                        Obejrzyj nasz poradnik wideo, aby dowiedzieć się więcej o korzystaniu z naszej strony z
                        przepisami:
                    </p>
