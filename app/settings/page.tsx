                ...
                <div className="relative ml-2 group transition-transform duration-300 ease-in-out hover:scale-110">
                    ...
                    <div
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                            Na tej stronie możesz dostosować swoje ustawienia konta, w tym dane osobowe, preferencje
                            językowe i jednostki miary.
                        </p>
                    </div>
                </div>
            </div>
            <form onSubmit={handleSubmit} className="grid gap-8 md:grid-cols-2">
                ...
                <Card className="bg-white dark:bg-gray-800 border-green-200 dark:border-green-700">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <Button type="submit"
                                className="bg-green-600 text-white hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-600">Zapisz
                            preferencje</Button>
                    </CardContent>
                </Card>
            </form>
