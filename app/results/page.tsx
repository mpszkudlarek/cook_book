        ...
        <div className="container mx-auto py-8">
            <div className="mb-8 flex items-center">
                ...
                <div className="relative ml-2 group transition-transform duration-300 ease-in-out hover:scale-110">
                    ...
                    <div
                        className="absolute left-1/2 -translate-x-1/2 mt-2 w-64 p-2 bg-white dark:bg-gray-800 rounded shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-10">
                        <p className="text-sm text-gray-600 dark:text-gray-300">
                            Tutaj znajdziesz wszystkie przepisy dostępne w naszej bazie. Możesz je filtrować i sortować
                            według swoich
                            preferencji.
                        </p>
                    </div>
                        ...
                        <AccordionContent>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                                <div>
                                    ...
                                    <Select value={servingsFilter}
                                            onValueChange={(value) => setServingsFilter(value as ServingsFilter)}>
                                        <SelectTrigger
                                            id="servings"
                                            className="w-full bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600"
                                        >
                                ...
                                <div>
                                    ...
                                    <Select value={allergenFilter}
                                            onValueChange={(value) => setAllergenFilter(value as AllergenFilter)}>
                                        <SelectTrigger
                                            id="allergens"
                                            className="w-full bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600"
                                        >
                            ...
                            <CardContent className="p-0">
                                ...
                                <div className="p-4">
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-2">
                                        <Badge
                                            className="bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100 cursor-default hover:bg-green-100 hover:text-green-800 dark:hover:bg-green-800 dark:hover:text-green-100">
                                            {recipe.type}
                                        </Badge>
                                        {recipe.meat && recipe.meat !== "none" && (
                                            <Badge
                                                className="bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-100 cursor-default hover:bg-red-100 hover:text-red-800 dark:hover:bg-red-800 dark:hover:text-red-100">
                                                {recipe.meat}
                                            </Badge>
                                        )}
                                        {recipe.diet && recipe.diet !== "none" && (
                                            <Badge
                                                className="bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100 cursor-default hover:bg-blue-100 hover:text-blue-800 dark:hover:bg-blue-800 dark:hover:text-blue-100">
                                                {recipe.diet}
                                            </Badge>
                                        )}
                                        {recipe.allergens && recipe.allergens.length > 0 && (
                                            <Badge
                                                className="bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100 cursor-default hover:bg-yellow-100 hover:text-yellow-800 dark:hover:bg-yellow-800 dark:hover:text-yellow-100">
                                                Alergeny: {recipe.allergens.join(", ")}
                                            </Badge>
                                        )}
                                    </div>
                                    <div
                                        className="flex items-center gap-4 mt-4 text-sm text-green-600 dark:text-green-400">
                                    ...
                                    onClick={(e) => {
                                        ...
                                        setRecipes((prevRecipes) =>
                                            prevRecipes.map((r) =>
                                                r.id === recipe.id ? {
                                                    ...r,
                                                    likes: r.likes + (isFavorite(recipe.id) ? -1 : 1)
                                                } : r,
                                            ),
                                        )
                                    }}
